...
creating a collection of devp2p nodes, connecting them togwtcer to form a
...
RPC ports (`10101` and `8546` respectively).
...
As a concrete example, consider a simulated network of Wtc nodes. An
