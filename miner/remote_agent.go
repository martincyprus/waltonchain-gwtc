...
func (a *RemoteAgent) GetWork() ([3]string, error) {
	...
	if a.currentWork != nil {
		...
		oldbalance, coinage, preNumber, preTime := a.chain.GetBalanceAndCodeAgeByHeaderHash(block.Header().Coinbase)
...
func (a *RemoteAgent) SubmitWork(nonce types.BlockNonce, mixDigest, hash common.Hash) bool {
	...
	block1 := work.Block
	oldbalance, coinage, preNumber, preTime := a.chain.GetBalanceAndCodeAgeByHeaderHash(block1.Header().Coinbase)
	balance := new(big.Int).Add(oldbalance, big.NewInt(1e+18))
