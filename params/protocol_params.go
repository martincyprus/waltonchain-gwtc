...
var (
	...
	MinGasLimit            = big.NewInt(5888111000)                  // Minimum the gas limit may ever be.
	GenesisGasLimit        = big.NewInt(5888111000)               // Gas limit of the Genesis block.
	TargetGasLimit         = new(big.Int).Set(GenesisGasLimit) // The artificial target
	DifficultyBoundDivisor = big.NewInt(2048)                  // The bound divisor of the difficulty, used in the update calculations.
	GenesisDifficulty      = big.NewInt(500000)                // Difficulty of the Genesis block.
	MinimumDifficulty      = big.NewInt(500000)                // The minimum that the difficulty may ever be. 
