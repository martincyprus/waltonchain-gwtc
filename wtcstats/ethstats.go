...
// Service implements an Wtc netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Wtc      // Full Wtc service if monitoring a full node
	les    *les.LightWtc // Light Wtc service if monitoring a light node
...
func New(url string, ethServ *eth.Wtc, lesServ *les.LightWtc) (*Service, error) {
