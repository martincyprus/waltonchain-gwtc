...
import (
	...
	"github.com/wtc/go-wtc/event/filter"
...
// Whisper represents a dark communication interface through the Wtc
...
// New creates a Whisper client ready to communicate through the Wtc P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
