...
import (
	...
	"github.com/wtc/go-wtc/logger"
	"github.com/wtc/go-wtc/p2p"
	"github.com/wtc/go-wtc/p2p/nat"
	"github.com/wtc/go-wtc/whisper"
)
...
func main() {
	...
	// Create an Wtc peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting Wtc peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start Wtc peer: %v.\n", err)
		os.Exit(1)
	}
