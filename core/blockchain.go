...
func (bc *BlockChain) GetBalanceAndCodeAgeByHeaderHash(addr common.Address) (*big.Int, *big.Int, *big.Int, *big.Int) {
	s,_,Number,Time :=bc.State()
	return s.GetBalance(addr),s.GetCodeAge(addr,Number,Time),Number,Time
}
