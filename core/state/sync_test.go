...
func makeTestState() (Database, *wtcdb.MemDatabase, common.Hash, []*testAccount) {
	// Create an empty state
	mem, _ := wtcdb.NewMemDatabase()
	db := NewDatabase(mem)
...
// account array.
func checkStateAccounts(t *testing.T, db wtcdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db wtcdb.Database, root common.Hash) error {
...
func checkStateConsistency(db wtcdb.Database, root common.Hash) error {
