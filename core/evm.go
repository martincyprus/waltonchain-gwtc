...
func Transfer(db vm.StateDB, sender, recipient common.Address, amount,Num,Time *big.Int) {
	db.SubBalance(sender, amount, Num, Time)
	db.AddBalance(recipient, amount, Num, Time)
}
