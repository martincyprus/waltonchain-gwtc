...
// that address/topic, and binary AND-ing those vectors togwtcer.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togwtcer
				var orVector []byte
...
// the reuested retrieval queue to be serviced togwtcer with other sessions.
//
