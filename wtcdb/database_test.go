...
func newTestLDB() (*wtcdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "wtcdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := wtcdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db wtcdb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db wtcdb.Database, t *testing.T) {
	const n = 8
